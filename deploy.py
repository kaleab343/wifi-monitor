...
def main():
    ...
    if success:
        ...
        print()
        print("You now have:")
        print("  ✅ Standalone executable: dist/WiFiRouterManager.exe")
        print("  ✅ Application icon: app_icon.ico")
        ...
        print("  📡 MITM Traffic Monitor - Real-time network traffic between router & devices")
        print("  📊 Complete device discovery (NetBIOS, mDNS, SSDP)")
        print("  📝 Device naming and management")
        print()
        print("MITM Traffic Monitor shows:")
        print("  • Upload/Download per device (KB)")
        print("  • Total packets transferred")
        print("  • Active connections")
        print("  • Last activity timestamps")
        print("  • Real-time bandwidth usage")
        print()
        print("To distribute:")
